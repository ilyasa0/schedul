...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _generateSchedule() async {
    ...
    try {
      String schedule = await geminiServices().generateSchedule(tasks);
      setState(() {
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                  "Priority: ${task.priority} | Duration: ${task.duration} minute | Deadline: ${task.deadline}"),
              trailing: IconButton(
  ...
  Widget _buildGenerateButton() {
    return isLoading
        ...
        : ElevatedButton(
            ...
            child:
                const Text("Generate Schedule", style: TextStyle(fontSize: 16)),
          );
  }
